...
//
// ASCOM CoverCalibrator driver for SympleFlipFlat
//
...
using HidSharp;
namespace ASCOM.SympleFlipFlat
{
    //
    // Your driver's DeviceID is ASCOM.SympleFlipFlat.CoverCalibrator
    //
    // The Guid attribute sets the CLSID for ASCOM.SympleFlipFlat.CoverCalibrator
    // The ClassInterface/None attribute prevents an empty interface called
    // _SympleFlipFlat from being created and used as the [default] interface
    //
    ...
    /// ASCOM CoverCalibrator Driver for SympleFlipFlat.
    /// </summary>
    [Guid("66e3a73e-3bcd-4640-a97b-56aff5e93c64")]
    ...
    public class CoverCalibrator : ICoverCalibratorV1
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.SympleFlipFlat.CoverCalibrator";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "SympleFlipFlat";
        ...
        #region ICoverCalibratorV1 variables
        //TODO: figure out out the most "C#" way of maintaining these variables
        //small class, tuple, array per var?
        private uint deviceCurrentBrightness = 0;
        private uint deviceSetBrightness = 0;
        private uint deviceMaxBrightness = 0;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SympleFlipFlat"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public CoverCalibrator()
        {
            tl = new TraceLogger("", "SympleFlipFlat");
        ...
        public bool updateConnectionStatus()
        {
            ...
            if (connectedState == false)
            {
                ...
                IEnumerable<HidDevice> candidate_devices = devices.GetHidDevices(56, 79);
